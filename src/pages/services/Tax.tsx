...
import { CheckCircle2, FileText, Shield, AlertTriangle, Scale, Building } from "lucide-react"
...
export default function Tax() {
  ...
  const services = [
    { icon: FileText, text: t("services.tax.services.calculation") },
    { icon: Shield, text: t("services.tax.services.filings") },
    { icon: FileText, text: t("services.tax.services.invoices") },
    { icon: CheckCircle2, text: t("services.tax.services.withholding") },
    { icon: Scale, text: t("services.tax.services.audit") },
    { icon: Building, text: t("services.tax.services.declarations") },
  ]

  const benefits = [
    {
      icon: Shield,
      title: t("services.tax.benefits.compliance.title"),
      description: t("services.tax.benefits.compliance.description"),
    },
    {
      icon: AlertTriangle,
      title: t("services.tax.benefits.risk.title"),
      description: t("services.tax.benefits.risk.description"),
    },
    {
      icon: CheckCircle2,
      title: t("services.tax.benefits.transparency.title"),
      description: t("services.tax.benefits.transparency.description"),
    },
  ]
  ...
  return (
    <>
      <SEO page="tax" path="/services/tax" />
