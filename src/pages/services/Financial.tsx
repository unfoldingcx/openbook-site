...
export default function Financial() {
  ...
  const benefits = [
    {
      icon: CheckCircle2,
      title: t("services.financial.benefits.control.title"),
      description: t("services.financial.benefits.control.description"),
    },
    {
      icon: BarChart3,
      title: t("services.financial.benefits.planning.title"),
      description: t("services.financial.benefits.planning.description"),
    },
    {
      icon: Globe,
  ...
  return (
    <>
      <SEO page="financial" path="/services/financial" />
